...
1. 大型项目前端启动速度成倍加快，几十个入口项目效果差距极大；

2. 修改某一个组件热更新更快，只重编译当前改动模块，不需要编译其他模块；

3. 内存占用更低，不用一次性加载全量模块依赖。

缺点：

1. 这是实验性配置，不是正式配置，可能少数情况存在不稳定

2. 对于小项目，优化前后不明显

3. 加载页面时，会先白屏，然后 webpack 开始编译，再次刷新页面才能显示出来
...
[https://2x.ant.design/docs/react/getting-started-cn#%E6%8C%89%E9%9C%80%E5%8A%A0%E8%BD%BD](https://2x.ant.design/docs/react/getting-started-cn#%E6%8C%89%E9%9C%80%E5%8A%A0%E8%BD%BD "https://2x.ant.design/docs/react/getting-started-cn#%E6%8C%89%E9%9C%80%E5%8A%A0%E8%BD%BD")
...
方法2 使用 [babel-plugin-import](https://github.com/ant-design/babel-plugin-import) 来进行按需加载
...
[https://ant-design.antgroup.com/docs/react/getting-started-cn#%E6%8C%89%E9%9C%80%E5%8A%A0%E8%BD%BD](https://ant-design.antgroup.com/docs/react/getting-started-cn#%E6%8C%89%E9%9C%80%E5%8A%A0%E8%BD%BD "https://ant-design.antgroup.com/docs/react/getting-started-cn#%E6%8C%89%E9%9C%80%E5%8A%A0%E8%BD%BD")
...
[https://article.juejin.cn/post/7404777192704868362](https://article.juejin.cn/post/7404777192704868362 "https://article.juejin.cn/post/7404777192704868362")

[https://juejin.cn/post/7415776780076105779](https://juejin.cn/post/7415776780076105779 "https://juejin.cn/post/7415776780076105779")
...
[https://juejin.cn/post/7048125682861703181?searchId=20241210183908A776F5DCCD3FF70873FF](https://juejin.cn/post/7048125682861703181?searchId=20241210183908A776F5DCCD3FF70873FF "https://juejin.cn/post/7048125682861703181?searchId=20241210183908A776F5DCCD3FF70873FF")

‌**Module Federation**‌是一种通过[Webpack](https://www.baidu.com/s?rsv_dl=re_dqa_generate\&sa=re_dqa_generate\&wd=Webpack\&rsv_pq=c6c76d0f001f8513\&oq=module%20federation\&rsv_t=a038Cg0zwpzBnm0RqRpTLISKvhvsaPbQgSTdZqZJN7cQZonOUje/vitXm/g\&tn=baidu\&ie=utf-8)插件实现的，应用间模块共享和动态加载的技术。
...
1. **独立性**：每个微前端模块可以独立开发和部署，使用不同的技术栈。

2. **团队自治**：不同团队可以负责不同的模块，增加了团队的灵活性和自主性。

3. **技术多样性**：各个模块可以使用不同的框架和库，如 React、Vue、Angular 等。

4. **渐进式迁移**：可以在现有应用中逐步引入微前端架构，而无需一次性重构整个应用。
...
[https://github.com/dilanx/craco](https://github.com/dilanx/craco "https://github.com/dilanx/craco")

[https://craco.js.org/](https://craco.js.org/ "https://craco.js.org/")

配置说明

[https://craco.js.org/docs/category/configuration/](https://craco.js.org/docs/category/configuration/ "https://craco.js.org/docs/category/configuration/")
...
[https://www.pnpm.cn/](https://www.pnpm.cn/ "https://www.pnpm.cn/")

速度快、节省磁盘空间

node\_modules 中的所有文件均克隆或硬链接自单一存储位置（类似 yarn 的单一存储位置）

pnpm 创建的 node\_modules 默认并非扁平结构，因此代码无法对任意软件包进行访问（但是不方便改源码调试）
