...
计算机技术的发展的目标，主要是为了业务的增长，具体体现在速度、精度、温度上面。

* 速度：开发迭代的速度快，主要涉及底层的云服务，以及容器复用快速开发的方面。

* 精度：用户的个性化推荐。根据用户的具体情况，进行科学的决策精准的分析。

* 温度：用户的内容与交互创新，持续提升用户的体验，传达产品的价值。

对于不同使用者的服务角度（以抖音为例，对于创作者的角度。要降低创作者的使用门槛。对于用户的角度。要增加产品的差异性体验）

以表格或者文档为例（对于创作者的角度，要方便创作者进行使用；技术门槛低；对于用户的角度，要便捷灵巧的浏览数据）

<img src="https://cloud.seatable.cn/workspace/32/asset/37d9be94-36c7-4add-8e78-fdf8564d701b/images/auto-upload/image-1719213211999.png" alt="" title="" width="681" height="332" />

<img src="https://cloud.seatable.cn/workspace/32/asset/37d9be94-36c7-4add-8e78-fdf8564d701b/images/auto-upload/image-1719213221017.png" alt="" title="" width="688" height="597" />

<img src="https://cloud.seatable.cn/workspace/32/asset/37d9be94-36c7-4add-8e78-fdf8564d701b/images/auto-upload/image-1719213231923.png" alt="" title="" width="683" height="375" />
...
rsPack 代码链接：[https://github.com/web-infra-dev/rsbuild](https://github.com/web-infra-dev/rsbuild "https://github.com/web-infra-dev/rsbuild") 2025年 1000 星，2026年 3000星
...
* Rspack 的特性，性能收益，架构设计

* 生态如何？兼容性如何？如何从 Webpack 迁移到 rspack
...
rspack 是基于 rust 的高性能 web 构建引擎（打包工具）

* Rust 实现增量编译，HMR 和构建速度更快
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1720497650949.png" alt="" title="" width="629" height="328" />

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1720497658291.png" alt="" title="" width="630" height="287" />
...
增量编译是在 make phase 时，递归进行编译（循环这个过程）
...
小项目，要求很快的速度和基本的使用场景，可以使用 rspack；但是复杂的项目，或者 angular，使用复杂的插件，那么这样还是使用 webpack。rust 语言速度比较快，社区发展也比较好，所以使用 rust 写 rspeck。
...
从项目角度，这个社区不完善，简单项目可以使用 rollup，复杂项目使用 webpack，这两个市场占有率这么大，长期稳定。如果再学习 rspack 有成本，所以不会把这个工具使用在实际生产项目中，后续观望市场占有率再说。


### 02  前端-组件化-quarkC
哈罗单车前端团队研发（中台团队比较小，响应降本增效做的项目（给业务部门提供公共组件））。

quarkC 是低成本、跨技术栈、无框架的组件，代码连接：[https://github.com/hellof2e/quark](https://github.com/hellof2e/quark "https://github.com/hellof2e/quark") 2025年300星，2026年 300星。最近1年没有改动过代码，目前看项目黄了。

web-component 概念：<https://juejin.cn/post/7350502488493867042>

简单理解，就是 HTML默认的 video 标签，实际是很多 div + span 组成的，那么这个 video 标签就是 web-component。这个项目也是类似的工作，写了例如 hello-button 这样的原生 web-component 组件。
...
* 面向未来的无框架浏览器原生组件探索与实践

#### 1、前端组件的缺陷

通用组件依赖于框架的种类和版本，不能通用（例如 antd 依赖于 react18版本）不能复用，CSS 的效果容易冲突。

如果一个企业历史代码比较多，那么不同的项目和人员使用技术栈不同，开发维护比较困难。

如果框架版本大升级后，各种组件库都需要升级，比较麻烦。
...
但是不同框架的事件处理不同，这也是痛点，兼容性等等也是痛点。

所以这个作者使用 quarkC 工具构建组件。
...
* 黑产（刷浏览点赞评论——根据文章内容，生成一个100字的优质评论）

* 绕过验证机制（自动识别验证码，自动识别滑动模块并跳过）；

* GPT 脾气暴躁化（用户恶性训练）

* 数据泄露(代码中可能有 key token 的验证数据)，训练数据库和核心数据的泄露

思考：

* 风险和效率并存——需要制定内部的使用规范和流程，合理使用

* 万无一失，一失全无——代码安全扫描，部分情况使用

未来发展：

* AI 识别生成模块代码，基于描述进行定制化开发

* 低代码 + 原子化开发

* 提示词工程师 = 超级个体开发工程师 = 产品+UI+研发+测试+运维+客服

* 语音编程：敲代码的第三只手，可以使用语音操控项目（操作聚合，语音控制）


### 04 前端 + ReactNative
雪球前端专家，10年从业经验

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721742074533.png" alt="" title="" width="435" height="314" />

01 RN 三段同构后的效果：H5 安卓 IOS 三个同构，只需要开发一次即可完成

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721742084850.png" alt="" title="" width="290" height="325" />

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721742093931.png" alt="" title="" width="592" height="288" />

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721742102786.png" alt="" title="" width="594" height="303" />
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721744755675.png" alt="" title="" width="629" height="365" />

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721744763433.png" alt="" title="" width="630" height="358" />

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721744830878.png" alt="" title="" width="407" height="332" />
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1720969889205.png" alt="" title="" width="206" height="283" />
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721633009160.png" alt="" title="" width="546" height="255" />
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721693522452.png" alt="" title="" width="653" height="346" />
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721694479601.png" alt="" title="" width="482" height="316" />
...
<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721695732366.png" alt="" title="" width="611" height="298" />

通过编译，可以生成 JS Java 和原生语言 exe

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721695738989.png" alt="" title="" width="428" height="395" />

理论上适配各种平台

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721695744850.png" alt="" title="" width="635" height="280" />

开发时也有对应工具，需要同时安装 Android 和 Xcode 等各个系统的开发环境

<img src="https://cloud.seatable.cn/workspace/81910/asset/b0de7002-5abf-48b9-b07b-ba7033be74a7/images/auto-upload/image-1721695751237.png" alt="" title="" width="640" height="335" />
